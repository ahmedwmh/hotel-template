    ...
    >
      <div className="flex flex-col items-center gap-8">
        ...
        <div className="flex items-center justify-center gap-2">
          <hr className="w-16 sm:w-24 h-px border-0 bg-[#c19d68]/60 dark:bg-amber-500/60" />
          <div className="relative flex h-14 w-14 items-center justify-center">
            <span
              className="absolute inset-0 rounded-full border-2 border-[#c19d68]/20 dark:border-amber-500/20"
              aria-hidden
            />
            <span
              className="absolute inset-0 animate-spin rounded-full border-2 border-transparent border-t-[#c19d68] dark:border-t-amber-400"
              style={{ animationDuration: "0.9s" }}
              aria-hidden
            />
            <span className="font-Garamond text-xl font-semibold text-[#c19d68] dark:text-amber-400">
              N
            </span>
          </div>
          <hr className="w-16 sm:w-24 h-px border-0 bg-[#c19d68]/60 dark:bg-amber-500/60" />
